...
public class UIManager : MonoBehaviour
{
    ...
    [Header("Chest UI")]
    public GameObject chestPanel,InventoryPanel,Trade,X;
    ...
    {   
        ...
        if (InventoryPanel.activeSelf||Trade!= null && Trade.activeSelf|| X!=null && X.activeSelf)
        {
    ...
    public void ShowOpenText(Chest chest, Vector3 Pos)
    {
